...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='FirstName']"), "Prish");
        sendTextToElement(By.xpath("//input[@id='LastName']"), "Cride");
        sendTextToElement(By.xpath("//input[@id='Email']"), "prish14@gmail.com");
        sendTextToElement(By.xpath("//input[@name= 'Password']"), "Prish@123");
        sendTextToElement(By.xpath("//input[@id='ConfirmPassword']"), "Prish@123");
        ...
        sendTextToElement(By.xpath("//input[@id='Email']"), "prish14@gmail.com");
        sendTextToElement(By.xpath("//input[@id='Password']"), "Prish@123");
